...
import com.example.android.notepad.provider.NotePadProvider;
...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = managedQuery(
                ...
                NotePadContract.Notes.DEFAULT_SORT_ORDER  // Use the default sort order.
        );
        /*
     ...
     * mimeTYpe NotePadContract.Notes.CONTENT_TYPE. If they do this, the code in onCreateOptionsMenu()
     ...
     * this triggers the NoteEditor activity in the NotePadContract application.
     * <p/>
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
           ...
           * In effect, this starts the NoteEditor Activity in NotePadContract.
           */
