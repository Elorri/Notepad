...
import com.example.android.notepad.provider.NotePadContract;
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            if (mState == STATE_EDIT) {
                ...
                int colTitleIndex = mCursor.getColumnIndex(NotePadContract.Notes.COLUMN_NAME_TITLE);
            ...
            int colNoteIndex = mCursor.getColumnIndex(NotePadContract.Notes.COLUMN_NAME_NOTE);
...
//BEGIN_INCLUDE(paste)
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            if (uri != null && NotePadContract.Notes.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(NotePadContract.Notes.COLUMN_NAME_MODIFICATION_DATE, System.currentTimeMillis());
        ...
        if (mState == STATE_INSERT) {
            ...
            values.put(NotePadContract.Notes.COLUMN_NAME_TITLE, title);
        } else if (title != null) {
            // In the values map, sets the value of the title
            values.put(NotePadContract.Notes.COLUMN_NAME_TITLE, title);
        }
        // This puts the desired notes text into the map.
        values.put(NotePadContract.Notes.COLUMN_NAME_NOTE, text);
        /*
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                mCursor = null;
                ContentValues values = new ContentValues();
                values.put(NotePadContract.Notes.COLUMN_NAME_NOTE, mOriginalContent);
